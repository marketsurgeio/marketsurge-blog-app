...
export async function generateThumbnailAction(title: string) {
  try {
    const width = 1200;
    const height = 628;
    const industry = 'Technology'; // You might want to make this configurable
